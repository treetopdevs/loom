defmodule Loom.Teams.Distributed do
  @moduledoc """
  Wrapper around Horde.DynamicSupervisor and Horde.Registry for distributed
  agent management.

  When clustering is enabled (`config :loom, :cluster, enabled: true`), agents
  ...
  alias Loom.Teams.Cluster

  require Logger

  @distributed_supervisor Loom.Teams.DistributedAgentSupervisor
  @distributed_registry Loom.Teams.DistributedAgentRegistry
  ...
  (local supervisor/registry are already started by `Loom.Teams.Supervisor`).
  """
