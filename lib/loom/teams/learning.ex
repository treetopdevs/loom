defmodule Loom.Teams.Learning do
  @moduledoc """
  ...
  `Loom.Teams.Tasks.complete_task/2` — after persisting cost via CostTracker,
  call:
  ...
  Similarly, `Loom.Teams.Tasks.fail_task/2` should record with `success: false`.
  """

  import Ecto.Query
  alias Loom.Repo
  alias Loom.Schemas.AgentMetric
