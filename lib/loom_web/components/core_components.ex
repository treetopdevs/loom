defmodule LoomWeb.CoreComponents do
  ...
  def input(%{type: "textarea"} = assigns) do
    ...
    <div>
      ...
      <textarea
        id={@id}
        name={@name}
        class="mt-1 block w-full rounded-lg bg-gray-800 border-gray-700 text-gray-100 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
        {@rest}
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 rounded-lg bg-indigo-600 hover:bg-indigo-500",
