defmodule Loom.Teams.DebateTest do
  use Loom.DataCase, async: false

  alias Loom.Teams.{Debate, Manager}
  ...
  describe "initiate_debate/4" do
    ...
    test "sends debate_start to all participants", %{team_id: team_id} do
      ...
      Loom.Teams.Comms.subscribe(team_id, "alice")
      Loom.Teams.Comms.subscribe(team_id, "bob")
  ...
  describe "voting and consensus" do
    test "tallies votes and determines winner", %{team_id: team_id} do
      Loom.Teams.Comms.subscribe(team_id, "alice")
      Loom.Teams.Comms.subscribe(team_id, "bob")
      Loom.Teams.Comms.subscribe(team_id, "carol")
