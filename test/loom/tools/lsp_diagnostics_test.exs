defmodule Loom.Tools.LspDiagnosticsTest do
  use ExUnit.Case, async: false

  alias Loom.Tools.LspDiagnostics
  ...
  setup %{tmp_dir: tmp_dir} do
    ...
    # The LSP Registry is already started by Loom.LSP.Supervisor in the application.
